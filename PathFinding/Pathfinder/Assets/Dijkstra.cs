...
public static class Dijkstra
{
    ...
    public static List<Connection> pathfind(Graph graph, Node start, Node goal, bool useTactical)
    {
        ...
        while (open.length() > 0)
        {
            ...
            foreach (Connection connection in connections)
            {
                ...
                float endNodeCost = current.costSoFar + connection.getCost(useTactical);
